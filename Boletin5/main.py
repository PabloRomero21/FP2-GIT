...
def main():
    ...
    if os.path.exists(ruta_pkl):
        ...
        print("SISTEMA: Procesando Excel y validando datos (esto puede tardar unos segundos)...")
        # La Factoría ahora devuelve directamente el objeto Liga completo,
        # ya con todas las validaciones aplicadas y los índices construidos.
        la_liga = FactoriaJugadores.crear_liga_desde_excel(ruta_xls, "La Liga Santander")
...
# --- EJERCICIO 11 (LOS 'N' MEJORES RATIOS GOLEADORES) ---
    ...
    # --- EJERCICIO 33 (RACHA SIN TARJETAS) ---
    print("--- EJERCICIO 33 ---")
    ...
    # --- EJERCICIO 35 (HISTORIAL EN FILAS) ---
